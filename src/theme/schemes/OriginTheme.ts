...
const breakpoints = { sm: 576, md: 960, lg: 1280, xl: 1600 };
...
export const OriginTheme = createTheme({
  ...
  typography: {
    // Log Example Code
    // fontSize: 'clamp(2.25rem, 2.75vw, 2.75rem)'
    // lineHeight: 1.5
    // color: colors.alpha.black[100]
    fontFamily:
    ...
    h1: {
      fontWeight: 700,
      lineHeight: 1.5,
      fontSize: `${fontPxToRemMinim(32)}`,
      '@media (min-width: 960px)': {
        fontSize: `${fontPxToRem(32)}`
      }
    },
    h2: {
      fontWeight: 700,
      lineHeight: 1.5,
      fontSize: `${fontPxToRemMinim(28)}`,
      '@media (min-width: 960px)': {
