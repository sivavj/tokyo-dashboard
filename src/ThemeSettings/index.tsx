          ...
          >
            <ThemeToggleWrapper>
              ...
              <Stack alignItems="center" spacing={2}>
                {/* TODO: Add Origin Theme */}
                <Tooltip placement="left" title="Origin Theme" arrow>
                  <ButtonWrapper
                    className={theme === "OriginTheme" ? "active" : ""}
                    onClick={() => {
                      changeTheme("OriginTheme");
                    }}
                  >
                    {theme === "OriginTheme" && (
                      <CheckSelected>
                    ...
                    <ColorSchemeWrapper className="colorSchemeWrapper originTheme">
